...
public class Config {
  ...
  public static final int REWARD_BIG_WIN = 5; //todo:// remote config reward big win (default x5)
  public static final int MULTI_MONEY_BET_BIG_WIN = 3; //todo:// remote config show big win (default 3)
